        ...
        <div className="mx-auto max-w-4xl px-6">
          {enviado ? (
            ...
            >
              ...
              <Field label="Nombre" type="text" placeholder="Tu nombre" required />
              <Field label="Apellidos" type="text" placeholder="Tus apellidos" required />
              <Field label="Compañía" type="text" placeholder="Nombre de la empresa" />
              <Field label="RUT Empresa" type="text" placeholder="12.345.678-9" />
              <Field label="Cargo" type="text" placeholder="Tu cargo en la empresa" />
              <Field label="Correo electrónico" type="email" placeholder="tu@email.com" required />
              <Field label="Móvil" type="tel" placeholder="+56 9 ..." />
              <Field label="Teléfono" type="tel" placeholder="+56 2 ..." />
              ...
              <Field label="Nombre de la obra o proyecto" type="text" placeholder="Ej: Planta procesadora Norte" />
              <Field label="Fecha de inicio estimada" type="date" />
              <div className="sm:col-span-2">
                <Field label="Dirección de la obra / proyecto" type="text" placeholder="Calle, número, ciudad" />
              </div>
