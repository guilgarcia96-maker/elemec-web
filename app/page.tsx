...
const services: Service[] = [
  {
    ...
    benefit:
      "Operación segura y conforme a normativa, con continuidad de servicio.",
  },
  {
    ...
    benefit:
      "Menor detención de equipos, mayor eficiencia y mayor vida útil de activos.",
  },
  {
    ...
    benefit:
      "Estabilidad eléctrica, eficiencia energética y menor riesgo operacional.",
  },
  {
  ...
  },
  {
    ...
    benefit:
      "Mayor eficiencia energética y confort térmico para climas extremos.",
  },
];
...
export default function Home() {
  const [version, setVersion] = useState<keyof typeof palettes>("azulDorado");
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)]" style={themeStyle}>
      ...
      <div className="mx-auto mt-4 flex max-w-6xl items-center justify-end px-6">
        <div className="inline-flex rounded-lg border border-[var(--border)] bg-[var(--card)] p-1 text-sm">
          <button
            type="button"
            onClick={() => setVersion("azulDorado")}
          ...
          <button
            type="button"
            onClick={() => setVersion("amarilloVerde")}
            className={`rounded-md px-3 py-1.5 transition ${
              version === "amarilloVerde"
                ? "bg-[var(--brand)] text-white"
                : "text-[var(--text-soft)] hover:bg-[var(--card-soft)]"
            }`}
          >
