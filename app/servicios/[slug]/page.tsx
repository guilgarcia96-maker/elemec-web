      ...
      <section className="border-b border-[var(--header-border)] bg-[var(--section-alt)] py-12">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <nav className="mb-4 flex items-center gap-2 text-xs text-[var(--text-soft)]">
            ...
            <span>/</span>
            <span className="text-[var(--accent)]">{servicio.titulo}</span>
          </nav>

          {/* Icono + título */}
          <div className="flex items-center gap-4">
            <div
              className={`flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br ${servicio.gradiente} text-4xl shadow-lg`}
            >
              {servicio.icono}
            </div>
            <div>
