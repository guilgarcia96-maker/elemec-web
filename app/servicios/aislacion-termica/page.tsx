...
const alcance = [
  {
    titulo: "Aislación de tuberías",
    foto: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?auto=format&fit=crop&w=800&h=560&q=80",
    descripcion:
      "Aplicación de aislación térmica en tuberías industriales con poliuretano expandido, lana mineral o espuma elastomérica. Soluciones adaptadas al tipo de fluido, temperatura de operación y condiciones ambientales del clima patagónico.",
    beneficios: [
      "Reducción de pérdidas térmicas en hasta un 80%",
      "Compatible con tuberías de vapor, agua caliente y fría",
      "Materiales certificados para uso industrial",
      "Aplicación en instalaciones en operación",
    ],
  },
  {
    ...
    descripcion:
      "Calorifugado técnico de calderas, intercambiadores de calor, generadores de vapor y equipos industriales. Aplicación de mantas de lana mineral, poliuretano proyectado y cubierta de aluminio para protección y eficiencia energética.",
    beneficios: [
      "Reducción de consumo energético del equipo",
      "Protección contra condensación y corrosión",
      "Cumplimiento de normativas de seguridad térmica",
      "Mayor vida útil del equipo aislado",
    ],
  },
  {
    titulo: "Cubiertas de aluminio",
    foto: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=800&h=560&q=80",
    descripcion:
      "Instalación de cubiertas y terminaciones en aluminio liso o corrugado sobre aislación de tuberías y equipos. Acabado profesional que protege la aislación de la intemperie, la humedad y el daño mecánico, extendiendo la vida útil del sistema.",
    beneficios: [
      "Protección frente a lluvia, viento y UV patagónico",
      "Acabado estético y ordenado en sala de máquinas",
      "Aluminio galvanizado de alta resistencia",
      "Sellado hermético en uniones y codos",
    ],
  },
  {
    titulo: "Cálculo térmico",
    foto: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=800&h=560&q=80",
    descripcion:
      "Cálculo de espesores óptimos de aislación y análisis de pérdidas térmicas para cada instalación. Entregamos una memoria de cálculo que justifica técnicamente la solución, considerando las temperaturas extremas del sur de Chile.",
    beneficios: [
      "Espesores optimizados según norma ASTM/ISO",
      "Análisis de retorno de inversión energética",
      "Temperatura media de diseño basada en datos locales",
      "Documentación técnica incluida en el entregable",
    ],
  },
  {
    titulo: "Cámaras frías",
    foto: "https://images.unsplash.com/photo-1581092335397-9583eb92d232?auto=format&fit=crop&w=800&h=560&q=80",
    descripcion:
      "Sistemas de aislación para cámaras frías y recintos criogénicos en la industria alimentaria, pesquera y de investigación. Paneles de poliuretano de alta densidad con barrera de vapor y sellado perimetral para control preciso de temperatura.",
    beneficios: [
      "Paneles de alta densidad con barrera de vapor",
      "Control preciso de temperatura interior",
      "Sellado hermético en puertas y esquinas",
      "Compatibilidad con sistemas de refrigeración existentes",
    ],
  },
];

export default function AislacionTermicaPage() {
    ...
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)]">
      ...
      <section className="relative overflow-hidden">
        <div
          ...
          style={{ backgroundImage: "url('/portada-aislacion-termica.jpg')" }}
        />
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-24 md:py-32">
          <nav className="mb-6 flex items-center gap-2 text-xs text-white/60">
            ...
            <span>/</span>
            <span className="text-white/90">Aislación Térmica</span>
          </nav>
          ...
          <h1 className="mt-5 text-5xl font-extrabold leading-tight text-white md:text-6xl">
            Aislación{" "}
            <span className="text-[var(--accent)]">Térmica.</span>
          </h1>
          <p className="mt-5 max-w-xl text-white/70 leading-relaxed">
            Eficiencia energética y confort térmico para climas extremos —
            soluciones técnicas para la industria austral de Chile.
          </p>
